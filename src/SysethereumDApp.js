...
class SysethereumDApp extends Component {
  ...
  handleEmailSubmit(evt) {
    evt.preventDefault();
    var self = this;
    window.open("https://syscoin.org/contact?e="+encodeURIComponent(this.state.emailSender)+"&n="+encodeURIComponent(this.state.emailName)+"&m="+encodeURIComponent(this.state.emailMessage), "_blank");  
  }
        ...
        <div className="section dark moreinfo">
          <div className="moreinfo">
            ...
            <div className="links">
              ...
              <a href="https://sys1.bcfn.org/" target="_blank" rel="noopener noreferrer">Syscoin explorer</a>
