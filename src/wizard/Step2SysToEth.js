...
class Step2 extends Component {
  ...
  isValidated() {
    ...
    if (
      ...
      if (
        this.props.getStore().txindex !== userInput.txindex ||
        this.props.getStore().txsiblings !== userInput.txsiblings ||
        this.props.getStore().syscoinblockheader !==
          userInput.syscoinblockheader ||
  ...
  async getProofs() {
    ...
    try {
      let results = await sjs.utils.fetchBackendSPVProof(
        ...
        this.props.getStore().txid.toString()
      );
      if (results.error) {
        ...
        if (results.result.length === 0) {
          ...
          if (!results.transaction) {
            ...
            console.log(
              "syscoinblockheaderVal " + validateNewInput.syscoinblockheader
            );
              ...
              <label className="col-md-12">
                <h1
                  dangerouslySetInnerHTML={{
                    __html: this.props.t("step2Head"),
                  }}
                ></h1>
                <h3
                  dangerouslySetInnerHTML={{
                    __html: this.props.t("step2Description"),
                  }}
                ></h3>
              </label>
