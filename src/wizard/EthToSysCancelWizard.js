...
import Step1ESC from './Step1EthToSysCancel';
import { withNamespaces } from 'react-i18next';
import './css/wizard.css';
import './css/i18n.css';

class EthToSysCancelWizard extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  render() {
    ...
    const steps =
    [
      {name: t("step1esc"), component: <Step1ESC t={t} getStore={() => (this.getStore())} updateStore={(u) => {this.updateStore(u)}} />}
...
export default withNamespaces("translations")(EthToSysCancelWizard);
