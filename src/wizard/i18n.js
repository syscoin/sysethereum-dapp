  ...
  resources: {
    en: {
      translations: {
        ...
        'step2ESDescription': 'Please enter the Transaction ID from your Ethereum burn transaction below if it is not already auto-filled.<br/> Click Generate to create the raw unsigned transaction before proceeding to the next step.',
    ...
    de: {
      translations: {
        ...
        'step1LastBlockBits': 'de: Previous Syscoin Difficulty Bits',
