  ...
  resources: {
    en: {
      translations: {
        ...
        'step1ESDescription': '<p><em>This is a wizard for a bridge for tokens on NEVM to move to Syscoin trustlessly.</em></p> <p>An SPV proof of the NEVM burn transaction is required to move back to Syscoin.</p><p> <strong>Please enter details about which asset to move back to Syscoin:</strong></p> Enter <code>123456</code> for <code className="blue">Asset GUID</code> if moving Syscoin (SYSX) over otherwise enter the GUID of the Asset token you are moving back to Syscoin.',
        ...
        'step2Head':  '<em className="step">Step 3:</em> Complete!',
        'step2Description': 'The button below will get the Syscoin Transaction SPV proof from Syscoin Core.',
    ...
    es: {
      translations: {
        ...
        'step2Description': 'Please fill out asset, amount, address and then click Burn to send the transaction via Pali before proceeding to the next step. Enter <code>123456</code> for <code className="blue">Asset GUID</code> if moving Syscoin (SYSX) over otherwise enter the GUID you are moving to NEVM.',
